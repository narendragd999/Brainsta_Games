let player, cursors, bullets, enemies, lastFired=0; let tiltX=0;
...
this.load.image('bg3','assets/bg_layer3.png');
this.load.image('bg4','assets/bg_layer4.png');
...
function create(){
this.add.image(400,300,'bg1'); this.add.image(400,300,'bg2').setAlpha(0.3);
this.add.image(400,300,'bg3').setAlpha(0.2); this.add.image(400,300,'bg4').setAlpha(0.1);
...
this.time.addEvent({delay:800,loop:true,callback:()=>{let x=Phaser.Math.Between(50,750); let e=enemies.create(x,0,'enemy'); e.setVelocityY(120);}});
